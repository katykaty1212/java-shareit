...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addComment(long userId, long itemId, CommentRequestDto commentRequestDtoDto) {
        return post("/" + itemId + "/comment", userId, commentRequestDtoDto);
    }
}